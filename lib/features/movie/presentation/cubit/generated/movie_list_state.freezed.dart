...
class _Success implements MovieListState {
...
class _Failure implements MovieListState {
  ...
  @override
  String toString() {
    return 'MovieListState.failure(message: $message)';
  }
}
