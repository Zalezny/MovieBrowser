  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Success() when success != null:
        return success(_that.movieDetails);
      case _Failure() when failure != null:
...
class _Success implements MovieDetailsState {
  const _Success(this.movieDetails);
...
class _Failure implements MovieDetailsState {
  ...
  @override
  String toString() {
    return 'MovieDetailsState.failure(message: $message)';
  }
}
