...
class _MovieApiService implements MovieApiService {
  ...
  @override
  Future<MovieListDto> searchMovies(String apiKey, String query) async {
    ...
    final _options = _setStreamType<MovieListDto>(
    ...
    late MovieListDto _value;
    try {
      _value = MovieListDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<MovieDetailsDto> getMovieDetails(int id, String apiKey) async {
    final _extra = <String, dynamic>{};
